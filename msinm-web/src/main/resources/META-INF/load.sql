...
insert into msi.area (id, parentArea_id) values  (0, null);
insert into msi.area (id, parentArea_id) values  (1, 0);
insert into msi.area (id, parentArea_id) values  (2, 0);
insert into msi.area (id, parentArea_id) values  (3, 1);
insert into msi.area (id, parentArea_id) values  (4, 3);
insert into msi.area (id, parentArea_id) values  (5, 3);
insert into msi.area (id, parentArea_id) values  (6, 1);
insert into msi.area (id, parentArea_id) values  (7, 6);
