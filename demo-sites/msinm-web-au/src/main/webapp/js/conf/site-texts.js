...
angular.module('msinm.conf')
    ...
    .config(['$translateProvider', function ($translateProvider) {
        ...
        $translateProvider.translations('en', {
            ...
            'FOOTER_COPYRIGHT': '&copy; 2015 AMSA',
            ...
            'FRONT_PAGE_MISC': '<h2>Report Observations</h2><p>If you observe an incident relevant to the maritime community, '
                ...
                + '<h2>Other sources</h2><p>Please find the official MSI and NM\'s for the Australian Area at:</p>'
                + '<ul><li><a href="http://www.amsa.gov.au/search-and-rescue/distress-and-safety-comms/msi/" target="_blank">Australian Maritime Authority</a></ul>'
